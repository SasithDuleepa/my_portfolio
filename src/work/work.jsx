...
export default function Work() {
  return (
    <div className='work-page-container'>
      ...
      <WorkCard image = 'img5' title='E-commerce Site' content='An online store platform that allows users to browse products, make purchases, and manage their accounts. The admin panel enables product management, order tracking, and customer support.'/>
