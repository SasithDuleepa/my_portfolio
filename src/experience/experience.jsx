...
export default function Experience() {
  return (
    <div className='exp-page-container'>
      ...
      <p className='header-p1'>Experience</p>
      <p className='header-p2'>Work Experience</p>
      ...
      <div className='experience-card-container'>
        <div className='exp-card-div'>
          ...
          <div className='exp-card-container'>
            ...
            <p className='body-p1'> I began my career as an intern software engineer, diving into the world of programming and technology.
        ...
        <div className='exp-card-div'>
          ...
          <div className='exp-card-container'>
            ...
            <p className='body-p1'>After my internship, I was promoted to Associate Software Engineer. In this role, 
